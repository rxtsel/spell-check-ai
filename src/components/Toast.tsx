...
export const Toast: React.FC<ToastProps> = ({ show }) => {
  return (
    <div className={`max-w-xs bg-white border rounded-md shadow-lg dark:bg-zinc-900 dark:border-zinc-800 fixed right-5 top-5 transition-opacity duration-500 ${show ? 'visible' : 'hidden'}`} role="alert">
